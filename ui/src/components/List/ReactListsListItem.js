...
// ---- List with user todolists name, not ready yet, wanna make it after DB requests, will make it 08.09.18 ----//
...
// export default class ReactListsListItem extends React.Component {
//   constructor(props) {
//     super(props);
//     this.state = {
