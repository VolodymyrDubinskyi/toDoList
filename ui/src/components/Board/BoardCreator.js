    ...
    return <div>
      <div style={{
        ...
        style={{
          ...
          float: 'left',
          borderRadius: 3,
          backgroundImage: this.props.newBoardColor,
        ...
        <div style={{
          ...
          <div className='createBoardColorsSelectList'>
            <div style={{ backgroundImage: 'url("/backgrounds/1.jpg")' }} className='createBoardImg'
              onClick={() => this.props.setParentState({ newBoardColor: 'url("/backgrounds/1.jpg")' })}></div>
            <div style={{ backgroundImage: 'url("/backgrounds/2.jpg")' }} className='createBoardImg'
              onClick={() => this.props.setParentState({ newBoardColor: 'url("/backgrounds/2.jpg")' })}></div>
            <div style={{ backgroundImage: 'url("/backgrounds/3.jpg")' }} className='createBoardImg'
              onClick={() => this.props.setParentState({ newBoardColor: 'url("/backgrounds/3.jpg")' })}></div>
